...
local fs = HORUS and 0 or SMLSIZE
...
return {
	...
	text = {},
	fields = {
		{ t = "Band",    x = 10,  y = 14 * fa, sp = 30 * fa, min=0, max=5, vals = { 2 }, to = fs, table = { [0]="U", "A", "B", "E", "F", "R" }, upd = function(self) self.handleBandChanUpdate(self) end },
		{ t = "Chan",    x = 10,  y = 24 * fa, sp = 30 * fa, min=1, max=8, vals = { 3 }, to = fs, upd = function(self) self.handleBandChanUpdate(self) end },
		{ t = "Power",   x = 10,  y = 34 * fa, sp = 30 * fa, min=1, vals = { 4 }, to = fs, upd = function(self) self.updatePowerTable(self) end },
		{ t = "Pit",     x = 10,  y = 44 * fa, sp = 30 * fa, min=0, max=1, vals = { 5 }, to = fs, table = { [0]="OFF", "ON" } },
		{ t = "Dev",     x = 70 * fa,  y = 14 * fa, sp = 25 * fa, write = false, ro = true, vals = { 1 }, to = fs , table = { [1]="6705",[3]="SA",[4]="Tramp",[255]="None"} },
		{ t = "Freq",    x = 70 * fa,  y = 24 * fa, sp = 25 * fa, min = 5000, max = 5999, vals = { 6 }, to = fs, upd = function(self) self.handleFreqValUpdate(self) end },
	},
	freqLookup = {
