return {
    ...
    fields = {
        ...
        { x = 150, y = 110,  vals = { 9 },    min = 0,   max = 1, to = MIDSIZE, table = { [0] = "OFF", "ON" }, upd = function(self) self.updateRateTables(self) end },
        { x = 150, y = 155, vals = { 1 },    min = 1,   max = 32, to = MIDSIZE, upd = function(self) self.updatePidRateTable(self) end },
        { x = 150, y = 200, vals = { 2 },    min = 1,   max = 16, to = MIDSIZE },
        { x = 150, y = 242, vals = { 3 },    min = 0,   max =  1, to = MIDSIZE, table = { [0] = "OFF", "ON" } },
